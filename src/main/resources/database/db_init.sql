...
ALTER TABLE `account`
    ADD FOREIGN KEY (`user_id`) REFERENCES `person` (`person_id`);

ALTER TABLE `person`
    ADD FOREIGN KEY (`faculty_id`) REFERENCES `faculty` (`faculty_id`);

ALTER TABLE `preclusion`
    ADD FOREIGN KEY (`preclusion_id`) REFERENCES `course` (`course_id`);

ALTER TABLE `preclusion`
    ADD FOREIGN KEY (`course_id`) REFERENCES `course` (`course_id`);

ALTER TABLE `prerequisite`
    ADD FOREIGN KEY (`prerequisite_id`) REFERENCES `course` (`course_id`);
...
ALTER TABLE `classroom_schedule`
    ADD FOREIGN KEY (`professor_id`) REFERENCES `account` (`user_id`);

ALTER TABLE `classroom_schedule`
    ADD FOREIGN KEY (`class_id`) REFERENCES `class` (`class_id`);

ALTER TABLE `enrollment`
    ADD FOREIGN KEY (`student_id`) REFERENCES `account` (`user_id`);
...
ALTER TABLE `submission`
    ADD FOREIGN KEY (`deliverable_id`) REFERENCES `deliverable` (`deliverable_id`);
